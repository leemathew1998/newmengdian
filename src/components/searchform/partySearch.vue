		...
		<a-form layout="inline" :form="form" @submit="handleSubmit" class="form">
			<div class="formRegion">
				...
				<a-form-item>
					<a-input v-decorator="[
                'mpNo',
                { rules: [{ message: '请输入计量点编号' }] },
              ]" placeholder="计量点编号" :style="{ width: '150px' }" allowClear>
						<!-- @change="ande" 实时-->
					</a-input>
				</a-form-item>
				<!-- 用户名称 -->
                ...
                'voltCode',
                { rules: [{ message: '请选择电压等级' }] },
              ]" placeholder="请选择电压等级" :style="{ width: '150px' }" allowClear>
                ...
                { rules: [{ message: '请选择供电单位' }] },
						...
						<a-select-option value="河西供电服务中心"> 河西供电服务中心 </a-select-option>
						<a-select-option value="河东供电服务中心"> 河东供电服务中心 </a-select-option>
					</a-select>
				</a-form-item> -->
				<!-- 标记时间 -->
				<!-- <a-form-item>
