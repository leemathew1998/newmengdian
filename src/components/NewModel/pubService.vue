          ...
          <div class="center">
            ...
            >
              ...
              >
                ...
                >
                  <a-table
                    :columns="popoverData.value.columns"
                    :data-source="popoverData.value.data"
                    :pagination="false"
                  >
                  </a-table>
                </template>
...
export default {
  ...
  methods: {
    ...
    async timeCalculation () {
      ...
      //   this.popoverData.value.data.push({
      //     'index': data[i].name,
    ...
    async phaseCalculation () {
      ...
      //     'powerSupply': res[i].powerSupply,
      //     'powerSell': res[i].powerSell,
      //     'powerLoss': res[i].powerLoss,
