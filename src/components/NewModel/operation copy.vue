          ...
          <div class="last">
            <div class="left">
              <a-collapse accordion>
                <a-collapse-panel key="1" header="故障点/危机缺陷照片">
                  ...
                  >
                    <div
                      style="padding-top: 20px; margin-left: 5px"
                ...
                <a-collapse-panel key="2" header="抢修单照片">
                  <div
                    v-if="situation.length ? situation[0].picture : false"
                    class="imageList"
                  >
                    <div
                      style="padding-top: 20px; margin-left: 5px"
                ...
                <a-collapse-panel key="3" header="监控班许可照片">
                  <div
                    v-if="situation.length ? situation[0].photograph : false"
                    class="imageList"
                  >
                    <div
                      style="padding-top: 20px; margin-left: 5px"
                      v-for="item in situation.length
                        ? situation[0].photograph
                        : []"
                      :key="item"
                    >
                      <img
                ...
                <a-collapse-panel key="4" header="安全措施照片">
                  <div
                    v-if="situation.length ? situation[0].caption : false"
                    class="imageList"
                  >
                    <div
                      style="padding-top: 20px; margin-left: 5px"
            ...
            <div class="right">
              <a-collapse accordion>
                <a-collapse-panel
                  key="5"
                  header="到岗位置许可检查安全措施是否完备照片并同意开工照片"
                >
                  <div
                    v-if="situation.length ? situation[0].pin : false"
                    class="imageList"
                  >
                    <div
                      style="padding-top: 20px; margin-left: 5px"
                      v-for="item in situation.length ? situation[0].pin : []"
                      :key="item"
                    >
                      <img
                        :src="item"
                ...
                <a-collapse-panel key="6" header="故障/危急缺陷处理后照片">
                  <div
                    v-if="situation.length ? situation[0].print : false"
                    class="imageList"
                  >
                    <div
                      style="padding-top: 20px; margin-left: 5px"
                      v-for="item in situation.length ? situation[0].print : []"
                      :key="item"
                    >
                      <img
                        :src="item"
                ...
                <a-collapse-panel key="7" header="安全措施拆除照片">
                  <div
                    v-if="situation.length ? situation[0].photoprint : false"
                    class="imageList"
                  >
                    <div
                      style="padding-top: 20px; margin-left: 5px"
                      v-for="item in situation.length
                        ? situation[0].photoprint
                        : []"
                      :key="item"
                    >
                      <img
